...
class RentsControllerTest < ActionController::TestCase
  ...
  test "should create rent" do
    assert_difference('Rent.count') do
      post :create, rent: { book_id: @rent.book_id, ended_at: @rent.ended_at, started_at: @rent.started_at, user_id: @rent.user_id }
    end
  ...
  test "should update rent" do
    put :update, id: @rent, rent: { book_id: @rent.book_id, ended_at: @rent.ended_at, started_at: @rent.started_at, user_id: @rent.user_id }
    assert_redirected_to rent_path(assigns(:rent))
  end
